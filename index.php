    ...
    <main>         
      <section class="find-a-place if-prefers-reduced-motion">
        ...
        <form method="get" action="/action_file.php">
          ...
          <span class="research-1"><span class="research-2"><span class="research-3"><span class="research-4"><input class="find-a-place__research" type="search" name="ville" id="rechercher" placeholder="Quartier, ville" alt="Vous pouvez indiquer un lieu où recherchez un restaurant" required></span></span></span></span>
        </form>
      </section>
      <section class="discovery"> 
        ...
        <button class="order-btn if-prefers-reduced-motion">Explorer nos restaurants</button>
      </section>
      ...
      <section class="restaurants">
        ...
        <nav class="restaurants__all-cards">
          ...
          <article class="restaurants__card">
            <span class="restaurants__thumbnail-new start-lag if-prefers-reduced-motion">Nouveau</span>
          ...
          <a href="./la-note-enchantee.php" title="Vers la page des menus du restaurants">
            <article class="restaurants__card">
            <span class="restaurants__thumbnail-new if-prefers-reduced-motion">Nouveau</span>
